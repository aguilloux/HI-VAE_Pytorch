...
def run(MC_id):
    ...
    case_list = ["seed11", "seed12", "method2", "method3"]
    ...
    for case in case_list:
        ...
        for d, perc_control in enumerate(list_n_samples_control):
            ...
            for generator_name in generators_sel:
                ...
                best_params_file = os.path.join(base_path, "optuna_results", "best_params_{}_ntrials{}_{}_{}_{}.json".format(name_config, n_trials, metric_optuna, generator_name, case))
        ...
        results.to_csv(f"{parent_path}/dataset/{dataset_name}/results_{case}_{metric_optuna}_n_samples_{n_samples}_n_features_bytype_{n_features_bytype}_MC_{MC_init}to{MC_final}.csv")
