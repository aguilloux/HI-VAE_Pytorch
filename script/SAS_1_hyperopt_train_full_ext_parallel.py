...
def run(generator_name, dataset_name):
    ...
    study_name = original_dir + "/dataset/" + dataset_name + "/optuna_results/optuna_study_ext_{}_ntrials{}_{}_{}".format(name_config, n_trials, metric_optuna, generator_name)
    best_params_file = original_dir + "/dataset/" + dataset_name + "/optuna_results/best_params_ext_{}_ntrials{}_{}_{}.json".format(name_config, n_trials, metric_optuna, generator_name)
