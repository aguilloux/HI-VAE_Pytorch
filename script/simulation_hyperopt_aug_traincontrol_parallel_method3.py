...
def run(generator_name):
    ...
    for d, perc_control in enumerate(list_n_samples_control):
        ...
        method_hyperopt = "train_train_gen_full"
        ...
        study_name = parent_path + "/dataset/" + dataset_name + "/optuna_results/optuna_study_{}_ntrials{}_{}_{}_method3".format(name_config, n_trials, metric_optuna, generator_name)
        best_params_file = parent_path + "/dataset/" + dataset_name + "/optuna_results/best_params_{}_ntrials{}_{}_{}_method3.json".format(name_config, n_trials, metric_optuna, generator_name)
