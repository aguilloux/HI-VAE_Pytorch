...
def run(generator_name):
    ...
    # Save the data
    dataset_name = "Simulations_6_indep_train_full"
    ...
    data_file_full = "./dataset/" + dataset_name + "/data_full.csv"
    feat_types_file_full = "./dataset/" + dataset_name + "/data_types_full.csv"
